...
const faqs = [
  {
    ...
    answer:
      "You can tell Trippo the type of trip you want to take, as well as some additional details. It'll give you a list of destinations that match your criteria, then generate an itinerary for your adventure.",
  },
  {
    question: "Is it free?",
    answer:
      "You charge however much you want. You're the one building this throuhgout this module!",
  },
  {
    question: "Wait, this is part of a course?",
    answer:
      "Yes! Trippo is the first of four projects you'll build as part of learnnext.ai. If you're interested in building real-world AI applications powered by Next.js, check it out!",
  },
];
      ...
      <div className="flex flex-col mx-auto max-w-5xl">
        ...
        <section className="text-center mt-12 md:mt-20">
          ...
          <p className="mb-8 text-lg">
            Find the perfect hidden-gem travel destination for your next trip,
            <br />
          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-8">
            <div className="lg:col-span-5">
              ...
              <p className="mt-4 text-base leading-7 text-gray-600">
                Interested in building this yourself? Enroll in the course today
                at{" "}
                <Link
